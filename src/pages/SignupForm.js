    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <div className="input-box">
                ...
                <input type="text" id="cpf" name="cpf" value={cpf} onChange={(e) => setCpf(e.target.value)} placeholder="123.456.789-00" required />
            </div>
            <div className="input-box">
            ...
            <div className="input-box">
                ...
                <input type="text" id="zip_code" name="zip_code" value={zipCode} onChange={(e) => setZipCode(e.target.value)} placeholder="25685050" required />
            </div>
